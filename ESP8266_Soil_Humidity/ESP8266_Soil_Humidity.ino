...
void loop() {
  ...
  client.println("      redColor: '#FF3232',");
  client.println("      greenFrom: 25, greenTo: 75,");
  client.println("      greenColor: '#46C646',");
  client.println("      yellowFrom: 75, yellowTo: 100,");
  client.println("      yellowColor: '#1589FF',");
